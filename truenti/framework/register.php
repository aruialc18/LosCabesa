                    ...
                    <div class="col-sm-12  col-md-6">
                       <h1>Registro</h1>
                        <form action="registeruser.php" method="POST" class="form-login">
                            <input type="text" name="usuario" class="form-control-sm" placeholder="Usuario"><br><br>
                            <input type="text" name="correo" class="form-control-sm" placeholder="Correo Electrónico"><br><br>
                            <input type="password" name="password" class="form-control-sm" placeholder="Contraseña"><br><br>
