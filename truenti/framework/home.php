        ...
        <div class="container-fluid separatop ">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 ">
                        <input 
                            class="bg-primary form-control-sm" type="submit" value="Enviar">
                        </input>
            ...
            <div class="row separatop">
                ...
                <div class="col-10 d-flex align-items-center">
                    <textarea rows="4" cols="130" placeholder="Usuario0239: Me gusta mucho el deporte jeje"
                        readonly>
                    </textarea>
                </div>
                <div class="row">
            ...
            <div class="row separatop">
                ...
                <div class="col-10 d-flex align-items-center">
                    <textarea rows="4" cols="130"
                        placeholder="Usuario023u4ri023: Hoy hice 43KM a 3,52Km/h, un record para mi!!!! "
                        readonly></textarea>
